	...
	context "#new" do
		...
		context "when logged in" do
			...
			should "assign a new user friendship" do
				get :new, friend_id: users(:jim)
				assert assigns(:user_friendship), "Did not assign user_friendship"
			end

			should "assign a new user friendship to the correct friend" do
				get :new, friend_id: users(:jim)
				assert_equal users(:jim), assigns(:user_friendship).friend, "user_friendship not equal to jim"
			end
			...
			should "returns at 404 status if no friend is found" do 
